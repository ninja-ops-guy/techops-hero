...
for(const src of [ "v57_hooks.js", "v64_hooks.js", "v69_hooks.js", "v70_hooks.js", "v710_hooks.js", "v716_hooks.js", "v735_hooks.js", "campaign_sector04_runtime.js", "good_boys_canon_runtime.js"]) assert.strictEqual(refFor(src),src+"?v=20260912-night-reviewed-r1");
for(const src of ["v55_hooks.js","v730_hooks.js"]) assert.strictEqual(refFor(src),src+"?v=20260912-directional-integrated-r2");

for(const src of ["night_hooks.js","v733_hooks.js","campaign_native_act2.js"]) assert.strictEqual(refFor(src),src+"?v=20260913-production-v43-night-story-r1");

assert.strictEqual(refFor("game.js"),"game.js?v="+bootstrapBuild[1]);
