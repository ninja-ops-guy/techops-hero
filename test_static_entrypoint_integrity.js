...
for(const src of ["good_boys_bible_world.js","good_boys_access_core_authority.js"]){assert.strictEqual(refFor(src),src+"?v=20260912-pr12-canon");}
for(const src of ["cinematic_systems.js","good_boys_progression_authority.js","night_hooks.js","v736_hooks.js","katrin_manchez.atlas.js","campaign_story.js"]){assert.strictEqual(refFor(src),src+"?v=20260912-local-coop-r1");}
const bgNocRef=refFor("bg_noc.js");assert.strictEqual(bgNocRef,"bg_noc.js?v=20260912-local-coop-r1","production bootstrap entrypoint must bypass stale mobile caches");
[
