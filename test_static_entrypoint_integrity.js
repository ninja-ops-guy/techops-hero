...
const bgNocRef=refFor("bg_noc.js");assert.strictEqual(bgNocRef,"bg_noc.js?v=20260912-directional-integrated-r1","production bootstrap entrypoint must bypass stale mobile caches");
[
