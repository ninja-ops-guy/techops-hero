/* TechOps Hero — complete production asset registry v12.
...
(function(root){
  ...
  var SCRIPT_ASSETS=[
    ...
    "interiors.js","interiors.atlas.js","k_action.atlas.js","k_full.atlas.js","k_studio.atlas.js","katrin_manchez.atlas.js","manchez_katrin_hits_p1.js","manchez_katrin_hits_p2.js","manchez_katrin_hits_p3.js","manchez_katrin_hits_p4.js",
  ...
  var PNG_ASSETS=[
    "assets/visual-combat/mike-moves.png","assets/visual-combat/waldo-props.png",
    ...
    "assets/good_boys/good_ship_arcade.atlas.png","assets/cinematic/m3_orbital_prison_breach.png",
  ...
  var JPG_ASSETS=["assets/v736/good_boys_ship/cockpit_pilot.jpg"];
  var WEBP_ASSETS=["assets/visual-combat/industrial.webp","assets/visual-combat/longwharf.webp","assets/visual-combat/gooddogs-home.webp","assets/visual-combat/waldo.webp","assets/visual-combat/home.webp"];
  ...
  var JSON_ASSETS=["assets/visual-combat/mike-moves.json","assets/visual-combat/scene-sources.json","assets/visual-combat/waldo-props.json","assets/handoff/atlas.json","assets/campaign/production_source_manifest.json","assets/v736/katrin_manchez_manifest.json","assets/cutscenes/good_dogs/campaign_clip_manifest_v2_2_pixel.json"];
  ...
  function loadScript(src){return new Promise(function(resolve){try{if(scriptAlready(src)){loadedScripts[src]=true;delete failedScripts[src];resolve(true);return;}var s=root.document.createElement("script");s.src=src+"?v="+(root.TechOpsProductionBootstrap?root.TechOpsProductionBootstrap.BUILD:"20260913-visual-combat-r1");s.async=false;s.dataset.productionAsset=src;s.onload=function(){loadedScripts[src]=true;delete failedScripts[src];resolve(true);};s.onerror=function(){failedScripts[src]=true;resolve(false);};(root.document.head||root.document.documentElement).appendChild(s);}catch(e){failedScripts[src]=true;resolve(false);}});}
