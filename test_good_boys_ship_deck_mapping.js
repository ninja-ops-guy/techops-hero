...
assert.ok(entry.includes("katrin_manchez.atlas.js?v=20260912-local-coop-r2"), "entrypoint must bypass stale board-action and animation metadata");
...
assert.ok(entry.includes("campaign_story.js?v=20260912-local-coop-r2"), "entrypoint must bypass the stale campaign story bootstrap");
