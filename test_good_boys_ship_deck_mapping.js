...
assert.ok(entry.includes("campaign_story.js?v=20260921-presentation-r1"), "entrypoint must bypass the stale campaign story bootstrap");
assert.ok(entry.includes("good_dogs_cutscenes_v2_2.js?v=20260920-quality-r1"), "entrypoint must pull the picked pilot/crash cache chain");
