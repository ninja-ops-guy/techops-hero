...
(function(root){
  ...
  function startNext(next){try{if(root.S&&!cinematicVisible())root.S.inDialog=false;if(next===8&&root.TechOpsGoodBoysEarthfallEnding&&typeof root.TechOpsGoodBoysEarthfallEnding.begin==="function"){root.TechOpsGoodBoysEarthfallEnding.begin();return true;}if(root.v736&&typeof root.v736.start==="function"){root.v736.start();return true;}}catch(e){root.__goodBoysProgressionError=String(e&&e.stack||e);}return false;}
  function advance(next,reason){
    try{
      ...
      var restart=function(){try{startNext(next);}finally{root.setTimeout(function(){transition=false;},500);}};
