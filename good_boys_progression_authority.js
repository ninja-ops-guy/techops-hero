...
(function(root){
  ...
  function completionStatus(which){
    try{
      ...
      else if(which===5){ok=!!c._gbAccessNodeSeized;reason=ok?"complete":"access-node-not-seized";}
