...
(function(root){
  ...
  function installHudAuthority(){try{if(productionCompositorActive())return false;if(typeof root.drawNM!=="function"||root.drawNM.__productionStableCompositor||root.drawNM.__goodBoysCanon)return false;baseDraw=root.drawNM;root.drawNM=function(){var r=baseDraw.apply(this,arguments);try{if(active()&&root.ctx)drawHud(root.ctx);}catch(_){}return r;};root.drawNM.__goodBoysCanon=true;return true;}catch(e){return false;}}
