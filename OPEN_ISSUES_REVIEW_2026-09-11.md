...
- The old v736 M7 completion dialog could survive behind the completed Earthfall sequence and leave inDialog set. Legacy mission completion now delegates to the existing canonical progression authority, including when that authority refuses a transition. Standalone legacy behavior is regression-tested.
...
- Repair candidate: 44-suite aggregate gate passed, including the new combat, world-isolation, completion-ownership and repair-integrity tests.
...
- Chromium encounter-fixture progression passed through M3, Cell 118/K, the M5–M7 cutscenes, real Warden tandem-finisher damage, all four Earthfall cards, and final rescue/unlock/no-dialog assertions. The normal-player route and mobile device acceptance remain separate.
...
- These checks do not prove unassisted M4–M8 gameplay, all main-campaign endings, physical-device behavior, or production certification. The original progression bot stopped after Cell 118. This branch restores the later mission cutscenes, real Warden finisher, Earthfall and unlock assertions; the real Warden finisher exposed a legacy M7 completion dialog behind Earthfall. The provider now delegates completion to the canonical progression authority, and the full fixture path passes with both unlocks set and no remaining dialog.
