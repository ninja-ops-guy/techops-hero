...
assert.match(storySource, /campaign_native_act1_visuals\.js\?v=20260903-good-ship-gameplay-assets-r2/, "campaign story must bypass stale mobile visual bootstrap cache");
...
assert.match(visualBootstrap, /good_boys_button_hard_fix\.js\?v=20260903-good-ship-gameplay-assets-r2/, "visual bootstrap must request the repaired Good Boys handoff owner");
