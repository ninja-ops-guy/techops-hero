...
assert.match(storySource, /campaign_native_act1_visuals\.js\?v=20260921-presentation-r1/, "campaign story must bypass stale mobile visual bootstrap cache");
assert.match(visualBootstrap, /good_boys_button_hard_fix\.js\?v=20260920-quality-r2/, "visual bootstrap must request the canonical M1-first Good Dogs handoff owner");
