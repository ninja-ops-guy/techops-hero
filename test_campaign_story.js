...
assert.match(visualBootstrap, /good_boys_button_hard_fix\.js\?v=20260911-cinematic-cohesion-r1/, "visual bootstrap must request the canonical M1-first Good Dogs handoff owner");
