...
assert.match(storySource, /campaign_native_act1_visuals\.js\?v=20260912-local-coop-r1/, "campaign story must bypass stale mobile visual bootstrap cache");
assert.match(visualBootstrap, /good_boys_button_hard_fix\.js\?v=20260912-local-coop-r1/, "visual bootstrap must request the canonical M1-first Good Dogs handoff owner");
