...
// -> one premise -> TAKE CONTROL -> canonical numeric M2 handoff.
assert.ok(source.includes('VERSION=10'), "direct Good Boys opening must be v10");
...
assert.ok(source.includes('gbiRepairInstalled==="10"'), "launch listener must install idempotently at v10");
