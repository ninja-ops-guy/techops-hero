...
function scriptIndex(src) {
  ...
  const match = urls.find(m => m[1].split("?")[0] === src.split("?")[0]);
...
const campaignAct1 = scriptIndex("campaign_act1.js?v=20260912-gameplay-continuation-r4");
...
const nativeAct1 = scriptIndex("campaign_native_act1.js?v=20260912-gameplay-continuation-r4");
