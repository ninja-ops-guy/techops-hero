...
(function(root){
  ...
  var LEGACY_STAGES={
    ...
    5:{platforms:[],hazards:[],landmarks:[{x:760,label:"K — ROUTE KEY",kind:"k"},{x:980,label:"THE MIKE INDEX",kind:"boss"},{x:1070,label:"ACCESS NODE",kind:"console"},{x:1480,label:"ROUTE 1984",kind:"door"}]},
