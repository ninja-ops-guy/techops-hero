...
(function(root){
  ...
  root.TechOpsNightCombat={VERSION:2,RULES,MOVES,active,state,attack,tick,stepEnemy,blocked:blockedContact,hurt,cancel,pose,draw,target,normalizeInput,readInput,jumpCancel,grab:(n,k)=>attack(n,k,'grab'),kick:(n,k)=>attack(n,k,'kick')};
