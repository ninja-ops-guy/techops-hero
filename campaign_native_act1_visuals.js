...
(function(root){
  ...
  if(!root.TechOpsGoodDogsCoop)load("good_dogs_coop.js?v=20260912-local-coop-r2","__techopsGoodDogsCoopLoader");
  if(!root.TechOpsGoodDogsHomeScene)load("good_dogs_home_scene.js?v=20260912-local-coop-r2","__techopsGoodDogsHomeSceneLoader");
  if(!root.TechOpsGoodBoysButtonHardFix||Number(root.TechOpsGoodBoysButtonHardFix.VERSION||0)<16)load("good_boys_button_hard_fix.js?v=20260912-local-coop-r2","__techopsGoodBoysButtonHardFixLoaderV16");
