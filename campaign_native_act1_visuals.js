...
(function(root){
  ...
  if(!root.TechOpsGoodBoysButtonHardFix||Number(root.TechOpsGoodBoysButtonHardFix.VERSION||0)<14)load("good_boys_button_hard_fix.js?v=20260911-cinematic-cohesion-r1","__techopsGoodBoysButtonHardFixLoaderV14");
