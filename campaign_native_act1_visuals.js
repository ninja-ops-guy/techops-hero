...
(function(root){
  ...
  if(!root.TechOpsCampaignNativeAct1Visuals)load("campaign_native_act1_visuals_impl.js?v=20260912-gameplay-feedback-r1","__techopsAct1VisualImplLoader");
  ...
  if(!root.TechOpsGoodDogsHomeScene)load("good_dogs_home_scene.js?v=20260920-revision-r1","__techopsGoodDogsHomeSceneLoader");
  if(!root.TechOpsGoodBoysButtonHardFix||Number(root.TechOpsGoodBoysButtonHardFix.VERSION||0)<16)load("good_boys_button_hard_fix.js?v=20260920-revision-r1","__techopsGoodBoysButtonHardFixLoaderV16");
