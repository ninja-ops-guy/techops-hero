...
(function(root){
  ...
  if(!root.GoodDogsCutscenes||parseFloat(root.GoodDogsCutscenes.VERSION||0)<3.2)load("good_dogs_cutscenes_v2_2.js?v=20260903-no-transmission-flash-r1","__techopsGoodDogsCutsceneV32Loader");
  ...
  if(!root.TechOpsGoodBoysShipDeckScene||Number(root.TechOpsGoodBoysShipDeckScene.VERSION||0)<6)load("good_boys_ship_deck_scene.js?v=20260903-deck-center-r1","__techopsGoodBoysShipDeckSceneLoaderV6");
  ...
  if(!root.TechOpsGoodBoysButtonHardFix||Number(root.TechOpsGoodBoysButtonHardFix.VERSION||0)<11)load("good_boys_button_hard_fix.js?v=20260903-good-ship-handoff-r1","__techopsGoodBoysButtonHardFixLoaderV11");
