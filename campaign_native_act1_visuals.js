...
(function(root){
  ...
  if(!root.GoodDogsCutscenes||parseFloat(root.GoodDogsCutscenes.VERSION||0)<3.3)load("good_dogs_cutscenes_v2_2.js?v=20260903-no-transmission-overlay-r2","__techopsGoodDogsCutsceneV33Loader");
  ...
  if(!root.TechOpsGoodBoysButtonHardFix||Number(root.TechOpsGoodBoysButtonHardFix.VERSION||0)<12)load("good_boys_button_hard_fix.js?v=20260903-good-ship-gameplay-assets-r2","__techopsGoodBoysButtonHardFixLoaderV12");
