...
(function(root){
  ...
  var BUILD="20260912-production-v35-east-side-r1";
  ...
  function loadEastSide(){if(!appendScript('data-techops-east-side','east_side.js',loadProgression,function(){root.__eastSideWireError='east_side.js';loadProgression();}))loadProgression();}
  function loadCampaignState(){if(!appendScript('data-good-dogs-campaign-state','good_dogs_campaign_state.js',loadEastSide,function(){root.__goodDogsCampaignStateWireError='good_dogs_campaign_state.js';loadEastSide();}))loadEastSide();}
