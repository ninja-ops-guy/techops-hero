...
try{
  ...
  await page.waitForSelector('#good-boys-ship-interlude',{state:'visible',timeout:4000});a=await snap(page);log('ship-start',a);assertOwner(a,'ship-start');if(!a.shipApi||a.shipApi.total!==3)fail('ship-three-system-contract-missing',a);if(a.active)fail('clip-overlaps-ship',a);
