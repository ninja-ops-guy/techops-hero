...
try{for(const viewport of [{width:1280,height:800},{width:390,height:844}]){
 ...
 for(const file of ['cinematic_systems.js','orbital_tiles.source.js','orbital_tiles.atlas.js','good_boys_prison_cinematic_patch.js','production_gameplay_experience.js','orbital_scene_staging.js','good_boys_gameplay_loop.js','good_boys_hud_lite.js','runtime_combat_audio.js','night_combat.js'])await page.addScriptTag({content:fs.readFileSync(file,'utf8')});
