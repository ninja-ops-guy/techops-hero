...
(function(root){
  ...
  var SCENES=[
    ...
    {title:"GOOD DOGS PROTOCOL — COMPLETE",kicker:"118 FREE · 1984 FREE",body:"K walks out under his own name. Waldo walks back through his own door. Katrin and Manchez do what they came to do: bring everyone home.",goal:"BREAKOUT COMPLETE · KATRIN + MANCHEZ UNLOCKED",frames:["sh_wreck"],cta:"END OPERATION"}
  ];
