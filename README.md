# TechOps Hero v7.26 — AeroTech Division
...
3. **🌀 Portal battle** — turn-based combat where **Uncertainty is the real enemy**: gather weighted evidence (testimony, logs, network, config), prune the root-cause tree, and only then hypothesize at 60%+ Confidence. Blind fixes backfire and build tech debt.
