...
(function(root){
  ...
  if(!root.TechOpsLevelRegistry){
    ...
    function goodBoysDistricts(){var out={};GOOD_DOGS.forEach(function(row){out[row.environment.district]=clone(row.districtConfig);out[row.environment.district].name=row.zone;});return out;}
